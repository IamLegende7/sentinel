...
const  std::string PATH_DEFAULTS_TILES =             RESOURCE_DIR + "/registry/tiles.jsonc";
inline std::string PATH_TEXTURES =                   RESOURCE_DIR + "/registry/textures.jsonc";
//inline std::string PATH_TEXTURES =                   RESOURCE_DIR + "/texturepacks/programerart/programer.jsonc"; // TODO: add a way to switch between texturepacks in-game
